...
@interface BackgroundTextureAccessViewController () <BackgroundTextureAccessEAGLDelegate>
...
- (void)backgroundTextureView:(id)view trackableResults:(NSArray *)results {
    NSLog(@"trackable result %@", results[0]);
}
